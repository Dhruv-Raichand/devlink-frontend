const Footer = () => {
  return (
    <footer className="relative z-10 mt-auto">
      <div className="w-full bg-white/5 dark:bg-gray-900/20 backdrop-blur-md border-t border-white/10 dark:border-gray-700/10">
          ...
          <div className="sm:hidden flex flex-col items-center text-center space-y-4">
            ...
            <nav className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-white/10 hover:bg-white/20 text-white/70 hover:text-white rounded-xl transition-all">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
