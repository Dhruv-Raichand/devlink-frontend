...
import SilkContext from "../context/SilkContext";
...
const Body = () => {
  ...
  const getSilkColor = (pageColor) => {
    if (error) return "#ef4444"; // always red for error
    if (loading) return "#3b82f6"; // always blue for loading
