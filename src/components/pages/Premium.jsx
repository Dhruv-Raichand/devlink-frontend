  ...
  return (
    <div className="max-w-5xl mx-auto px-4 pt-10 pb-24">
      ...
      <div className="text-center mb-12">
        ...
        {/* Billing toggle */}
        <div className="inline-flex items-center gap-3 mt-8 bg-[#13121c] border border-[#1e1d28] rounded-xl p-1">
          <button
          ...
          <div
            ...
            {plan.badge && (
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="bg-violet-600 text-white text-[11px] font-semibold px-3 py-1 rounded-full whitespace-nowrap">
                  {plan.badge}
                </span>
              </div>
            )}
