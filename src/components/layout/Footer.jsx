    ...
    <footer className="border-t border-[#1e1d28] bg-[#0d0c16] px-6 md:px-10 py-5">
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#4a4760] ml-1">
        ...
        <div className="flex items-center gap-1">
          {SOCIAL_LINKS.map((s) => (
            <a
              ...
              aria-label={s.label}
              className="w-8 h-8 flex items-center justify-center rounded-lg text-[#4a4760] hover:text-[#9b8ec4] hover:bg-[#1a1928] border border-transparent hover:border-[#2d2b40] transition-all">
              {s.icon}
            </a>
          ))}
        </div>
